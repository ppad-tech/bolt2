...
Specification: https://github.com/lightning/bolts/blob/master/02-peer-protocol.md

## Project Structure

- `lib/` - library source (Lightning.Protocol.BOLT2)
...
- `ppad-bolt2.cabal` - cabal package definition
...
- Use newtypes liberally (e.g., ChannelId, Satoshis, Signature)
